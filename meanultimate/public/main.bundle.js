    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('You Logged-in', { cssClass: 'alert-success', timeout: 5000 });
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Please insert a valida email', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // Register User
        this.authService.registerUser(user).subscribe(function (data) {
            _this.flashMessage.show('Registration Complete', { classes: ['alert', 'alert-success'], timeout: 3000 });
            _this.router.navigate(['/login']);
        }, function (error) {
            if (error) {
                _this.flashMessage.show('Oops! Somethin went wrong', { classes: ['alert', 'alert-danger'], timeout: 3000 });
